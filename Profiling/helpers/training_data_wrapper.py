...
class TrainingDataWrapper():
	...
	def __init__(self, args):
		...
		if hasattr(args, 'test') and args.test is not None:
			if hasattr(util, 'prepare_predict_data'):
				self.test_data = util.prepare_predict_data(args.test, self.cell2id, self.zscore_method, self.std)
