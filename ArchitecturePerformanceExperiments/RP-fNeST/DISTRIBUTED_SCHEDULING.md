...
**Note (2026):** The Python `distributed_gpu_queue.py` helper described below is **not** shipped in this repository anymore. Use **Slurm**, **GNU Parallel**, or your site’s scheduler with **`jobs/uniform_random_do_di_snn_jobs.txt`**. The rest of this document remains as general background.
...
**Node 1:**
```bash
cd /nfs/ml_lab/projects/Pilot1_PreclinicalHPC/jchia_backup/jchia_l05_7-31-25/ArchitecturePerformanceExperiments/RSNN
