...
# Dense_fNeST: fully connected fast NeST-style network with direct input and per-layer predictions
class Dense_fNeST(nn.Module):
...
if __name__ == "__main__":
	...
	fc_nn_test = Dense_fNeST(genotype_hiddens=genotype_hiddens, seed=42)
