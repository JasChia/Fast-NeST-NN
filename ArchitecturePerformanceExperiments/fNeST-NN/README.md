...
```bash
cd ArchitecturePerformanceExperiments/fNeST-NN
...
Use the Conda **`environment.yml`** at the repository root (see root **`README.md`**; `conda activate fast-nest-nn`) with PyTorch, Optuna, pandas, and **`torchmetrics`**.
