"""Hyperparameter tuning for ERK_SNN (Erdos-Renyi Kernel Sparse Neural Network)."""
...
class OptunaSparseNNTrainer:
    """Hyperparameter tuning trainer for ERK_SNN using Optuna."""
    ...
    def exec_study(self) -> Dict[str, float]:
        ...
        storage = optuna.storages.JournalStorage(
            optuna.storages.JournalFileStorage(str(self.save_dir / "ERK_SNN_HTune.log"))
        )
    ...
    def train_model(self, trial: Trial) -> float:
        ...
        try:
            ...
            try:
                ...
                print(f"Warning: Trial {trial.number} failed to generate a satisfying ERK_SNN architecture.")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train ERK_SNN (Erdos-Renyi Kernel Sparse Neural Network)")
