# Hyperparameter tuning for FC_NN
...
import pandas as pd
import torch
from fc_nn_residual import FC_NN_Residual
...
parser = argparse.ArgumentParser(description = 'Train FC_NN')
...
class OptunaSparseNNTrainer():
    ...
    def setup_trials(self, trial):
        # Hyperparameter suggestions for FC_NN
