...
**Note (2026):** The Python `distributed_gpu_queue.py` helper described below is **not** shipped in this repository anymore. Use **Slurm**, **GNU Parallel**, or your site’s scheduler with bundled job lists under `jobs/` where provided.
