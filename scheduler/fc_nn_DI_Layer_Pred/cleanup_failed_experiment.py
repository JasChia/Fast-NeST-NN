...
Usage:
    ...
    python cleanup_failed_experiment.py --pattern "D5_*" --job-file jobs/fc_nn_di_layer_pred_advanced_jobs.json
...
class ExperimentCleaner:
    ...
    def _get_experiment_dir_from_job_id(self, job_id):
        ...
        # Job IDs are like D5_0, D57_1, etc.
        # Experiment directories are like results/D5/D5_0, results/D57/D57_1, etc.
