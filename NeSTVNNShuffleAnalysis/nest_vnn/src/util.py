...
def load_train_data(train_file, cell2id, zscore_method, std_file, seed=42):
...
def prepare_train_data(train_file, cell2id_mapping, zscore_method, std_file, seed=42):
	train_features, val_features, train_labels, val_labels = load_train_data(train_file, cell2id_mapping, zscore_method, std_file, seed)
